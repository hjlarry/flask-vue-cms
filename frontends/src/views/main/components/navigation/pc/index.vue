<template>
  <ul
    class="mx-auto max-w-[800px] px-[10px] pt-1 flex flex-wrap justify-left items-start relative text-base text-zinc-900 dark:text-zinc-500 font-bold overflow-hidden duration-500 dark:bg-zinc-800"
  ...
  >
    ...
    <div
      ...
      :class="isOpenCategories ? 'bottom-[10px]' : 'bottom-[3px]'"
